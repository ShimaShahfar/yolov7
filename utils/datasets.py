...
class Planitar(Dataset):
    def __init__(
        ...
        with open(self.path) as f:
            ...
            self.train_list = list(csv_reader)
        # path = r'../../../data/**/*.jpg'
    ...
    def __getitem__(self, idx):
        ...
        return image, labels, self.train_list[idx][0], 0

    def __len__(self):
        return len(self.train_list)

    def get_img(self, idx):
        image = Image.open(self.train_list[idx][0]).convert("RGB")
        return image

    def get_labels(self, idx):
        label_path = os.path.splitext(self.train_list[idx][0])[0] + ".json"
        labels = []
